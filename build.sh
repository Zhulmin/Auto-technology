...
projectPath=/Users/rain/Documents/移动开发_rain/Fotor
cd ..
cd $projectPath
...
echo  "开始编译workspace...."
xcodebuild  -workspace $projectName.xcworkspace -scheme Fotor\ Debug  -configuration $buildConfig clean build SYMROOT=$buildAppToDir
else
echo  "开始编译target...."
